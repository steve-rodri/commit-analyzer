...
export class ReportGenerationService {
   ...
   */
  filterByDateRange(commits: AnalyzedCommit[], dateRange: DateRange): AnalyzedCommit[] {
   ...
   */
  filterByCategory(commits: AnalyzedCommit[], category: Category): AnalyzedCommit[] {
    return commits.filter(commit => commit.getAnalysis().getCategory().equals(category))
  }
   ...
   */
  groupByCategory(commits: AnalyzedCommit[]): Map<CategoryType, AnalyzedCommit[]> {
   ...
   */
  sortByDate(commits: AnalyzedCommit[], ascending: boolean = false): AnalyzedCommit[] {
